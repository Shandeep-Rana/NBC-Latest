...
const NbcMembers = () => {
    ...
    const { skilledPersons, isLoading, totalCount } = useSelector((state) => state.person);
    ...
    useEffect(() => {
        ...
        const delayDebounce = setTimeout(() => {
            dispatch(getAllSkilledPersons(state.search, state.page, state.pageSize, state.selectedVillage))
                ...
                <>
                    ...
                    <div className="page-team">
                        <div className="container">
                            ...
                            <div className="row">
                                {skilledPersons?.length > 0 ? (
                                    skilledPersons.map((member) => (
                                        <div key={member.id || member.email} className="col-lg-4 col-md-6">
                                            <div className="team-item wow fadeInUp">
                                                <div className="team-image">
                                                    <Link href="/team-single.html" data-cursor-text="View">
                                                        <figure className="image-anime">
                                                            <Image
                                                                src={member.userProfile || '/default-user.png'}
                                                                alt={member.name}
                                                                width={300}
                                                                height={300}
                                                            />
