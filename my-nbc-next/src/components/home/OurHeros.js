          ...
          <div className="col-lg-8">
            <div className="hero-content">
              <div className="section-title">
                ...
                <p className="wow fadeInUp" data-wow-delay="0.2s">Welcome to www.nangalbycycle.com, your gateway to your community empowerment and support, We are dedicated to fostering a strong sense of community across 100+ villages in our area. Whether you're seeking volunteer opportunities, looking to contribute as a blood donor, sharing local insights through blogs, or accessing vital services, you've come to the right place. Our volunteer platform serves as a central hub for connecting individuals, organizations, and resources to make a positive impact.</p>
              </div>
